import {Circle, DisplayObject, Rectangle, Group, Line, Stage} from '@chabb/sprite';
...
function makeGunTurret({x, y, rotationSpeed, firingRate}) {
  ...
  const gunTurret = new Group(box, turret);
  turret.x = 16;
  turret.y = 16;
...
export function setup(config: any, socket: any) {
